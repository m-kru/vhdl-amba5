...
package body checker is
  ...
  begin
    return clock(checker, to_stream1024(stream), ready, clear, 2);
  end;
  ...
  begin
    return clock(checker, to_stream1024(stream), ready, clear, 4);
  end;
  ...
  begin
    return clock(checker, to_stream1024(stream), ready, clear, 8);
  end;
